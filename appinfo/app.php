...
$domains = \OC::$server->getConfig()->getSystemValue("cbox.wopi.officeonline", ['https://login.cern.ch', 'https://oos.web.cern.ch', 'https://cbox-wopidev-01.cern.ch:8443', 'https://oos-dev2017.cern.ch/', 'https://msoo-lb-dev.cern.ch']);
