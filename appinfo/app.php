...
$domains = \OC::$server->getConfig()->getSystemValue("cbox.wopi.officeonline", ['https://login.cern.ch', 'https://oos.web.cern.ch', 'https://msoo-lb.cern.ch', 'https://wopi.cernbox.cern.ch:8443', 'https://msoo-lb-dev.cern.ch', '*.officeapps.live.com']);
